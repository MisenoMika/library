...
int main()
{
    ...
    for(int num=0;num<20;num++)
    {
        ...
        {
            if(a[num]==1){
            cout<<"No."<<num+1<<" The weather is sunny and rainy"<<endl;
            }
            if(a[num]==2){
            cout<<"No."<<num+1<<" The weather is sunny and not rainy"<<endl;
            }
            if(a[num]==3){
            cout<<"No."<<num+1<<" The weather is rainy and windy"<<endl;
            }
            if(a[num]==4){
            cout<<"No."<<num+1<<" The weather is rainy and not windy"<<endl;          
            }
            if(a[num]==5){
            cout<<"No."<<num+1<<" The weather is overcast"<<endl;
            }
